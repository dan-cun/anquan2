...
class Settings(BaseSettings):
    ...
    runtime_simple_max_seconds: int = Field(default=120, ge=10, le=7200)
    runtime_simple_max_agents: int = Field(default=6, ge=1, le=128)
    runtime_standard_max_seconds: int = Field(default=300, ge=10, le=7200)
    runtime_standard_max_agents: int = Field(default=12, ge=1, le=128)
    runtime_complex_max_seconds: int = Field(default=600, ge=10, le=7200)
    runtime_complex_max_agents: int = Field(default=20, ge=1, le=128)
    runtime_soft_deadline_ratio: float = Field(default=0.7, gt=0, lt=1)
    runtime_tool_grace_deadline_ratio: float = Field(default=0.9, gt=0, le=1)
